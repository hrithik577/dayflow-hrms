...
# AI MUST NEVER QUERY DB DIRECTLY, GENERATE UNRESTRICTED SQL, OR EXECUTE ARBITRARY PYTHON.
# ---------------------------------------------------------
...
def tool_get_employee(db: Session, current_user: User, employee_id: Optional[int] = None) -> Dict[str, Any]:
    ...
    # Scope check: Employee can only view own profile
