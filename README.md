...
# Seed the database with demo users, 30 days of attendance, leave requests, payroll, policies, and audit logs
...
| :--- | :--- | :--- | :--- |
| 👑 **ADMIN** | `admin@dayflow.com` | `Admin@123` | Command Center, Workforce Analytics, AI Insights, Audit Trail, Payroll Management |
| 👩‍💼 **HR** | `hr.sarah@dayflow.com` | `HR@123` | Employee Directory, Attendance Logs, Leave Approvals, AI Copilot Workspace |
| 👨‍💻 **EMPLOYEE** | `rahul.sharma@dayflow.com` | `Emp@123` | Check-in/out, Apply for Leave, View Payslips, AI Assistant, Personal Timeline |
